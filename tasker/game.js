 ...
 ***********************************************************************/
function __sprite_2() { 
__sprite_init__(this, sprite_2, 40, 40, 0, 0, 'Box', 20, 0, 40, 0, 40, ['img/sprite_2_0.png']);
...
__instance_init__(this, object_control, null, 1, 0, sprite_2, 1, 0);
this.on_creation = function() {
with(this) {
// 1. Select the first <a> element in the entire document
const firstLink = document.querySelector('a');
// 2. Check if an element was actually found
if (firstLink) {
...
draw_set_linewidth(20)
draw_rectangle(0,0,tu_canvas.width-10,tu_canvas.height-10,true)
}
}
};
...
this.objects = [
[{o:object_control, x:0, y:0}]];
this.start = function() {
__room_start__(this, scene_4, 640, 480, 30, 255, 255, 255, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
